	...
	\item Scholarship Standards
		\begin{enumerate}
			...
			\begin{enumerate}
				...
				\begin{enumerate}
					\item That brother has a semester \gls{gpa} less than 2.35 and that brother did not have a \gls{gpa} greater than 3.00 the semester before.
				\end{enumerate}
				...
				\begin{enumerate}
					\item This brother is then still eligible for being brought up to Standards Board. 
				\end{enumerate}
				...
				\begin{enumerate}
					\item He has a semester \gls{gpa} less than 2.50.
				\end{enumerate}
			\end{enumerate}
